...
def runApp(containerName, tag, dockerHubUser, httpPortEx,httpPortIn){
    ...
    sh "docker run --rm -d -p $httpPortEx:$httpPortIn --name $containerName $dockerHubUser/$containerName:$tag -v ~/zerodash/zerodash-back:/home/zerodash/zerodash/zerodash-back"
